...
void LCD_Init(void)
{ 
//https://item.taobao.com/item.htm?spm=a1z10.5-c.w4002-1891666121.32.hqEYu4&id=25142720480
// NT35310 480*320
...
void DrawPicture_Center(u16 *PictureAddr)  
{
    ...
    PictureHeight = picuturepoint[1];
    PictureWidth  = picuturepoint[2];
      ...
      for (j=0;j<wbyte;j++)
      {
        ...
        for(m=0;m<8;m++)
        {
          if ( (tmp_char >>7-m) & 0x01 == 0x01)
            ...
            {
              POINT_COLOR = bkColor;// 背景颜色
			  LCD_DrawPoint(x+i,y+i-8); 
            }
        }
       }
    }  
